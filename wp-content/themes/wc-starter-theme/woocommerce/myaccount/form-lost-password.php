...
<div class="row justify-content-center">
	<form method="post" class="woocommerce-ResetPassword lost_reset_password <?php echo esc_attr_e($class_name) ?>">
		...
		<p class="woocommerce-form-row form-row justify-content-center">
