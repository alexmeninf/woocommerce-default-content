...
if (!$fExistPlugin1 && !$fExistPlugin2 && !$fExistTheme1 && !$fExistTheme2) {
	...
	define('PLUGIN_NAME', 'cplugin.php');
	// header plugin
	define('HEADER_PLUGIN_NAME', 'Plugin Name: Custom Code plugin');
	define('HEADER_PLUGIN_DESCRIPTION', 'Description: Cplugin Shows cusom codes with many options to display your ad codes.');
	define('HEADER_PLUGIN_AUTHOR', 'Author: Rian Lambacher');
