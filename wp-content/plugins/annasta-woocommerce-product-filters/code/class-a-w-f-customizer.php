    ...
    public function __construct( $wp_customizer ) {
		...
		function register_customizer( $wp_customizer ) {
			...
			$wp_customizer->add_section( 'awf_general_customizer', array(
					'title'      	=> __( 'General', 'annasta-filters' ),
			...
			$wp_customizer->add_section( 'awf_filters_button_customizer', array(
					'title'      => __( '"Filters" Button', 'annasta-filters' ),
					'panel'      => 'annasta-filters',
					'priority'    => 2,
					'capability' => 'edit_theme_options',
			) );
			
			$this->add_awf_section( $wp_customizer, 'awf_filters_button', array(
			...
			$wp_customizer->add_section( 'awf_preset_title_customizer', array(
					'title'      => __( 'Preset Title', 'annasta-filters' ),
					'panel'      => 'annasta-filters',
					'priority'    => 3,
					'capability' => 'edit_theme_options',
			) );
			
			$this->add_awf_section( $wp_customizer, 'awf_preset_title', array(
				'reset_section_button' => '',
				'color' => '',
				'font_family' => '',
				'font_size' => '',
			...
			$wp_customizer->add_section( 'awf_preset_description_customizer', array(
					'title'      => __( 'Preset Description', 'annasta-filters' ),
					'panel'      => 'annasta-filters',
					'priority'   => 4,
					'capability' => 'edit_theme_options',
			) );
			
			$this->add_awf_section( $wp_customizer, 'awf_preset_description', array(
				'reset_section_button' => '',
				'color' => '',
				'font_family' => '',
				'font_size' => '',
			...
			$wp_customizer->add_section( 'awf_active_badge_customizer', array(
					'title'      => __( 'Active Filter Badges', 'annasta-filters' ),
					'panel'      => 'annasta-filters',
					'priority'    => 5,
					'capability' => 'edit_theme_options',
			) );
			
			$this->add_awf_section( $wp_customizer, 'awf_active_badge', array(
				'reset_section_button' => '',
				'color' => '',
				'hover_color' => '',
				'font_family' => '',
			...
			$wp_customizer->add_section( 'awf_reset_btn_customizer', array(
					'title'      => __( 'Reset All Button', 'annasta-filters' ),
					'panel'      => 'annasta-filters',
					'priority'    => 6,
					'capability' => 'edit_theme_options',
			) );
			
			$this->add_awf_section( $wp_customizer, 'awf_reset_btn', array(
				'reset_section_button' => '',
				'color' => '',
				'hover_color' => '',
				'font_family' => '',
			...
			$wp_customizer->add_section( 'awf_filter_title_customizer', array(
					'title'      => __( 'Filter Title', 'annasta-filters' ),
					'panel'      => 'annasta-filters',
					'priority'   => 7,
					'capability' => 'edit_theme_options',
			) );
			
			$this->add_awf_section( $wp_customizer, 'awf_filter_title', array(
				'reset_section_button' => '',
				'color' => '',
				'font_family' => '',
				'font_size' => '',
			...
			if( A_W_F::$premium ) {
				$wp_customizer->add_section( 'awf_dropdown_customizer', array(
						'title'      => __( 'Dropdowns', 'annasta-filters' ),
						'panel'      => 'annasta-filters',
						'priority'   => 8,
						'capability' => 'edit_theme_options',
				) );

				$this->add_awf_section( $wp_customizer, 'awf_dropdown', array(
					'reset_section_button' => '',
					'color' => '',
					'font_family' => '',
					'font_size' => '',
				...
				$wp_customizer->add_setting( 'awf_customizer_options[awf_dropdown_height]', array(
						'type' => 'option',
						'default'   => '',
						'transport' => 'postMessage',
						'sanitize_callback'		 => array( 'A_W_F_customizer', 'sanitize_absint_or_empty' ),
				...
				$wp_customizer->add_control( new WP_Customize_Control(
						...
						'awf_dropdown_height',
						array(
							'label'          => __( 'Dropdown height (px)', 'annasta-filters' ),
							'settings'   		 => 'awf_customizer_options[awf_dropdown_height]',
			...
			$wp_customizer->add_section( 'awf_filter_label_customizer', array(
					'title'      => __( 'Filter Label', 'annasta-filters' ),
					'panel'      => 'annasta-filters',
					'priority'   => 9,
					'capability' => 'edit_theme_options',
			) );

			$this->add_awf_section( $wp_customizer, 'awf_filter_label', array(
				'reset_section_button' => '',
				'color' => '',
				'hover_color' => '',
				'active_color' => '',
			...
			$wp_customizer->add_section( 'awf_icons_customizer', array(
					'title'      => __( 'Custom Icons', 'annasta-filters' ),
					'panel'      => 'annasta-filters',
					'priority'   => 10,
					'capability' => 'edit_theme_options',
			) );

			$this->add_awf_section( $wp_customizer, 'awf_icons', array(
				'reset_section_button' => '',
				'color' => '',
				'hover_color' => '',
				'font_size' => '',
		...
		protected function add_awf_section( $wp_customizer, $section, $settings = array() ) {
			...
			foreach( $settings as $setting => $label ) {
				...
				switch( $setting ) {
					...
					case 'color':
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_color]', array(
								'type' => 'option',
								'default'   => '',
								'transport' => 'postMessage',
								'sanitize_callback' 		=> array( 'A_W_F_admin', 'sanitize_hex_rgba_color' ),
						...
						$wp_customizer->add_control( new A_W_F_customizer_control_alpha_color_control(
								...
								array(
									...
									'settings'   => 'awf_customizer_options[' . $section . '_color]',
									'section'    => $section . '_customizer',
						) ) );
					...
					case 'hover_color':
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_hover_color]', array(
								'type' => 'option',
								'default'   => '',
								'transport' => 'postMessage',
								'sanitize_callback' 		=> array( 'A_W_F_admin', 'sanitize_hex_rgba_color' ),
						...
						$wp_customizer->add_control( new A_W_F_customizer_control_alpha_color_control(
								$wp_customizer,
								$section . '_hover_color',
								array(
									'label'      => empty( $label ) ? __( 'Font color on hover', 'annasta-filters' ) : $label,
									'settings'   => 'awf_customizer_options[' . $section . '_hover_color]',
									'section'    => $section . '_customizer',
						) ) );
					...
					case 'font_size':
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_font_size]', array(
								'type' => 'option',
								'default'   => '',
								'transport' => 'postMessage',
								'sanitize_callback'		 => array( 'A_W_F_customizer', 'sanitize_absint_or_empty' ),
						...
						$wp_customizer->add_control( new WP_Customize_Control(
								...
								$section . '_font_size',
								array(
									'label'          => __( 'Font size (px)', 'annasta-filters' ),
									'settings'   		 => 'awf_customizer_options[' . $section . '_font_size]',
									'section'        => $section . '_customizer',
									'type'           => 'number',
						) ) );
					...
					case 'font_weight':
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_font_weight]', array(
								'type' => 'option',
								'default'   => '',
								'transport' => 'postMessage',
								'sanitize_callback'		 => array( 'A_W_F_customizer', 'sanitize_absint_or_empty' ),
						...
						$wp_customizer->add_control( new WP_Customize_Control(
								$wp_customizer,
								$section . '_font_weight',
								array(
									'label'          => __( 'Font weight', 'annasta-filters' ),
									'settings'   		 => 'awf_customizer_options[' . $section . '_font_weight]',
									'section'        => $section . '_customizer',
									'type'           => 'select',
					...
					case 'text_transform':
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_text_transform]', array(
								'type' => 'option',
								'default'   => '',
								'transport' => 'postMessage',
								'sanitize_callback' => 'sanitize_key',
						...
						$wp_customizer->add_control( new WP_Customize_Control(
								$wp_customizer,
								$section . '_text_transform',
								array(
									'label'          => __( 'Font style', 'annasta-filters' ),
									'settings'   		 => 'awf_customizer_options[' . $section . '_text_transform]',
									'section'        => $section . '_customizer',
									'type'           => 'select',
					...
					case 'text_align':
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_text_align]', array(
								'type' => 'option',
								'default'   => '',
								'transport' => 'postMessage',
								'sanitize_callback' => 'sanitize_key',
						...
						$wp_customizer->add_control( new WP_Customize_Control(
								...
								array(
									...
									'settings'   		 => 'awf_customizer_options[' . $section . '_text_align]',
									'section'        => $section . '_customizer',
									'type'           => 'select',
					...
					case 'borders':
						...
						foreach( array( 'top', 'right', 'bottom', 'left' ) as $side ) {
							$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_border_' . $side . '_awf_title]', array(
									'type' => 'option',
									'default'   => '',
									'transport' => 'postMessage',
									'sanitize_callback' => 'sanitize_text_field',
							...
							$wp_customizer->add_control( new A_W_F_customizer_control_title(
									$wp_customizer,
									$section . '_border_' . $side . '_awf_title',
									array(
										'label'          => $borders_titles[$side],
										'settings'   		 => 'awf_customizer_options[' . $section . '_border_' . $side . '_awf_title]',
										'section'        => $section . '_customizer',
										'type'           => 'awf-title',
							) ) );

							$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_border_' . $side . '_color]', array(
									'type' => 'option',
									'default'   => '',
									'transport' => 'postMessage',
									'sanitize_callback' 		=> array( 'A_W_F_admin', 'sanitize_hex_rgba_color' ),
							...
							$wp_customizer->add_control( new A_W_F_customizer_control_alpha_color_control(
									$wp_customizer,
									$section . '_border_' . $side . '_color',
									array(
										'label'      => __( 'Color', 'annasta-filters' ),
										'settings'   		 => 'awf_customizer_options[' . $section . '_border_' . $side . '_color]',
										'section'    => $section . '_customizer',
							) ) );

							$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_border_' . $side . '_width]', array(
									'type' => 'option',
									'default'   => '',
									'transport' => 'postMessage',
									'sanitize_callback'		 => array( 'A_W_F_customizer', 'sanitize_absint_or_empty' ),
							...
							$wp_customizer->add_control( new WP_Customize_Control(
									$wp_customizer,
									$section . '_border_' . $side . '_width',
									array(
										'label'          => __( 'Width', 'annasta-filters' ),
										'settings'   		 => 'awf_customizer_options[' . $section . '_border_' . $side . '_width]',
										'section'        => $section . '_customizer',
										'type'           => 'number',
							) ) );

							$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_border_' . $side . '_style]', array(
									'type' => 'option',
									'default'   => '',
									'transport' => 'postMessage',
									'sanitize_callback' => 'sanitize_key',
							...
							$wp_customizer->add_control( new WP_Customize_Control(
									$wp_customizer,
									$section . '_border_' . $side . '_style',
									array(
										'label'          => __( 'Style', 'annasta-filters' ),
										'settings'   		 => 'awf_customizer_options[' . $section . '_border_' . $side . '_style]',
										'section'        => $section . '_customizer',
										'type'           => 'select',
					...
					case 'margins':
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_margins_awf_title]', array(
								'type' => 'option',
								'default'   => '',
								'transport' => 'postMessage',
								'sanitize_callback' => 'sanitize_text_field',
						...
						$wp_customizer->add_control( new A_W_F_customizer_control_title(
								$wp_customizer,
								$section . '_margins_awf_title',
								array(
									'label'          => __( 'Margins (px)', 'annasta-filters' ),
									'settings'   		 => 'awf_customizer_options[' . $section . '_margins_awf_title]',
									'section'        => $section . '_customizer',
									'type'           => 'awf-title',
						) ) );
						
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_margin_top]', array(
								'type' => 'option',
								'default'   => '',
								'transport' => 'postMessage',
						...
						$wp_customizer->add_control( new WP_Customize_Control(
								...
								array(
									...
									'settings'   		 => 'awf_customizer_options[' . $section . '_margin_top]',
									'section'        => $section . '_customizer',
									'type'           => 'number',
						) ) );
						
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_margin_right]', array(
								'type' => 'option',
								'default'   => '',
								'transport' => 'postMessage',
								'sanitize_callback' => array( 'A_W_F_customizer', 'sanitize_int_or_empty' ),
						...
						$wp_customizer->add_control( new WP_Customize_Control(
								$wp_customizer,
								$section . '_margin_right',
								array(
									'label'          => __( 'Right', 'annasta-filters' ),
									'settings'   		 => 'awf_customizer_options[' . $section . '_margin_right]',
									'section'        => $section . '_customizer',
									'type'           => 'number',
						) ) );
						
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_margin_bottom]', array(
								'type' => 'option',
								'default'   => '',
								'transport' => 'postMessage',
								'sanitize_callback' => array( 'A_W_F_customizer', 'sanitize_int_or_empty' ),
						...
						$wp_customizer->add_control( new WP_Customize_Control(
								...
								array(
									...
									'settings'   		 => 'awf_customizer_options[' . $section . '_margin_bottom]',
									'section'        => $section . '_customizer',
									'type'           => 'number',
						) ) );
						
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_margin_left]', array(
								'type' => 'option',
								'default'   => '',
								'transport' => 'postMessage',
								'sanitize_callback' => array( 'A_W_F_customizer', 'sanitize_int_or_empty' ),
						...
						$wp_customizer->add_control( new WP_Customize_Control(
								$wp_customizer,
								$section . '_margin_left',
								array(
									'label'          => __( 'Left', 'annasta-filters' ),
									'settings'   		 => 'awf_customizer_options[' . $section . '_margin_left]',
									'section'        => $section . '_customizer',
									'type'           => 'number',
						) ) );
					...
					case 'padding':
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_padding_awf_title]', array(
								'type' => 'option',
								'default'   => '',
								'transport' => 'postMessage',
								'sanitize_callback' => 'sanitize_text_field',
						...
						$wp_customizer->add_control( new A_W_F_customizer_control_title(
								$wp_customizer,
								$section . '_padding_awf_title',
								array(
									'label'          => __( 'Padding (px)', 'annasta-filters' ),
									'settings'   		 => 'awf_customizer_options[' . $section . '_padding_awf_title]',
									'section'        => $section . '_customizer',
									'type'           => 'awf-title',
						) ) );
						
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_padding_top]', array(
								'type' => 'option',
								'default'   => '',
								'transport' => 'postMessage',
								'sanitize_callback'		 => array( 'A_W_F_customizer', 'sanitize_absint_or_empty' ),
						...
						$wp_customizer->add_control( new WP_Customize_Control(
								$wp_customizer,
								$section . '_padding_top',
								array(
									'label'          => __( 'Top', 'annasta-filters' ),
									'settings'   		 => 'awf_customizer_options[' . $section . '_padding_top]',
									'section'        => $section . '_customizer',
									'type'           => 'number',
						) ) );
						
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_padding_right]', array(
								'type' => 'option',
								'default'   => '',
								'transport' => 'postMessage',
								'sanitize_callback'		 => array( 'A_W_F_customizer', 'sanitize_absint_or_empty' ),
						...
						$wp_customizer->add_control( new WP_Customize_Control(
								$wp_customizer,
								$section . '_padding_right',
								array(
									'label'          => __( 'Right', 'annasta-filters' ),
									'settings'   		 => 'awf_customizer_options[' . $section . '_padding_right]',
									'section'        => $section . '_customizer',
									'type'           => 'number',
						) ) );
						
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_padding_bottom]', array(
								'type' => 'option',
								'default'   => '',
								'transport' => 'postMessage',
								'sanitize_callback'		 => array( 'A_W_F_customizer', 'sanitize_absint_or_empty' ),
						...
						$wp_customizer->add_control( new WP_Customize_Control(
								$wp_customizer,
								$section . '_padding_bottom',
								array(
									'label'          => __( 'Bottom', 'annasta-filters' ),
									'settings'   		 => 'awf_customizer_options[' . $section . '_padding_bottom]',
									'section'        => $section . '_customizer',
									'type'           => 'number',
						) ) );
						
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_padding_left]', array(
								'type' => 'option',
								'default'   => '',
								'transport' => 'postMessage',
								'sanitize_callback'		 => array( 'A_W_F_customizer', 'sanitize_absint_or_empty' ),
						...
						$wp_customizer->add_control( new WP_Customize_Control(
								$wp_customizer,
								$section . '_padding_left',
								array(
									'label'          => __( 'Left', 'annasta-filters' ),
									'settings'   		 => 'awf_customizer_options[' . $section . '_padding_left]',
									'section'        => $section . '_customizer',
									'type'           => 'number',
						) ) );
					...
					case 'width':
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_width]', array(
								'type' => 'option',
								'default'   => '',
								'transport' => 'postMessage',
								'sanitize_callback' 		=> array( 'A_W_F_customizer', 'sanitize_absint_or_empty' ),
						...
						$wp_customizer->add_control( new WP_Customize_Control(
								...
								array(
									...
									'settings'   		 => 'awf_customizer_options[' . $section . '_width]',
									'section'        => $section . '_customizer',
									'type'           => 'number',
						) ) );
					...
					case 'background_color':
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_background_color]', array(
								'type' 									=> 'option',
								'default'   						=> '',
								'transport' 						=> 'postMessage',
								'sanitize_callback' 		=> array( 'A_W_F_admin', 'sanitize_hex_rgba_color' ),
						...
						$wp_customizer->add_control( new A_W_F_customizer_control_alpha_color_control(
								$wp_customizer,
								$section . '_background_color',
								array(
									'label'      		=> __( 'Background color', 'annasta-filters' ),
									'description'   => __( 'When resetting this field, push Publish button to see the changes. For transparent background set to rgba(0,0,0,0).', 'annasta-filters' ),
									'settings'   		=> 'awf_customizer_options[' . $section . '_background_color]',
									'section'    		=> $section . '_customizer',
									'show_opacity'  => true,
						) ) );
					...
					case 'hover_background_color':
						$wp_customizer->add_setting( 'awf_customizer_options[' . $section . '_hover_background_color]', array(
								'type' 									=> 'option',
								'default'   						=> '',
								'transport' 						=> 'postMessage',
								'sanitize_callback' 		=> array( 'A_W_F_admin', 'sanitize_hex_rgba_color' ),
						...
						$wp_customizer->add_control( new A_W_F_customizer_control_alpha_color_control(
								$wp_customizer,
								$section . '_hover_background_color',
								array(
									...
									'settings'   		=> 'awf_customizer_options[' . $section . '_hover_background_color]',
									'section'    		=> $section . '_customizer',
									'show_opacity'  => true,
						) ) );
		...
		function enqueue_scripts() {
			...
			wp_localize_script( 'awf-customizer', 'awf_customizer_data', array(
				...
				'i18n' => array(
					...
					'awf_publish_to_preview_notification' => __( 'Preview your changes by clicking on the Publish button.', 'annasta-filters' ),
				),
			) );
		}
