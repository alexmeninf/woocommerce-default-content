  ...
  class A_W_F_preset_frontend extends A_W_F_preset {
    ...
    public function get_html() {
      ...
      if( in_array( $this->display_mode, array( 'togglable', 'togglable-on-s' ) ) ) {
        $html .= '<div class="awf-togglable-preset-close-btn" title="' . esc_attr__( 'Close filters', 'annasta-filters' ) .  '"><i class="fas fa-times"></i><span>' . esc_html__( 'Close filters', 'annasta-filters' ) .  '</span></div>';
      }
